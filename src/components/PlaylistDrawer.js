      ...
      >
        ...
        <List>
          {props.playlists.map((playlist, index) => (
            <ListItem button key={index} onClick={() => props.changePlaylist(index)}>
      ...
      <main className={classes.content}>
        {/* <div className={classes.toolbar} /> */}
					<Grid container direction='column' alignItems='stretch' className={classes.root}>
						<h2>{props.playlists[props.currentPlaylistIndex].name}</h2>
                ...
                property.
                */}
								{props.playlists[props.currentPlaylistIndex].music.map((song, index) => (
